...
Runs failed tests n-times until they pass or until the max number of retries are exhausted. This only works with [jest-circus](https://github.com/athecoder/jest/tree/master/packages/jest-circus)!
