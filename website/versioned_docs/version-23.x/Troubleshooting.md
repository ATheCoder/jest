...
While Jest is most of the time extremely fast on modern multi-core computers with fast SSDs, it may be slow on certain setups as our users [have](https://github.com/athecoder/jest/issues/1395) [discovered](https://github.com/athecoder/jest/issues/1524#issuecomment-260246008).

Based on the [findings](https://github.com/athecoder/jest/issues/1524#issuecomment-262366820), one way to mitigate this issue and improve the speed by up to 50% is to run tests sequentially.
